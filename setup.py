...
find_packages: This function is used to automatically discover and list all Python packages within a project. 
It searches through the project directory for any folders containing an __init__.py file (which indicates that the folder is a Python package) and returns a list of package names.
...
def get_requirements(file_path: str) -> List[str]:
    '''
    This function will return the list of requirements, excluding any -e . line.
    '''
    requirements = []
...
setup(
    ...
    version='0.0.1',
    author='Krish',
    author_email='krishshah2672003shah@gmail.com',
    packages=find_packages(),  # Automatically finds packages in the directory
    install_requires=get_requirements('requirements.txt'),
    # Additional metadata and options can be added here
)
